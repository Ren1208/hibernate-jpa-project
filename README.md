...
Переписать spring-jdbc-project с использованием Hibernate и Spring Data JPA. В проекте не должно быть ни одного SQL запроса. Должны быть реализованы
сущности (@Entity) Книга и Человек, репозитории и сервисы. 
